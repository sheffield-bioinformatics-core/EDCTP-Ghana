...
snakemake --config user_run_name=${USER_RUN_NAME} --snakefile ~/wc/EDCTP-Ghana/workflow/Snakefile --rerun-incomplete --use-conda --jobs 10 --latency-wait 120 --verbose --printshellcmds --stats snakemake_stats.json all
